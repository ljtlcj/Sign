...
public class AllMemberAdapter extends RecyclerView.Adapter<AllMemberAdapter.ViewHolder> {
    ...
    public AllMemberAdapter(List<AllMemberBean> list) {
        this.list = list;
    }
...
//            id = itemView.findViewById(R.id.et_input);
    ...
    @Override
    public AllMemberAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AllMemberAdapter.ViewHolder holder, final int position) {
