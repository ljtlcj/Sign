...
public class MeetingCheckDetailNoMemberActivity extends BaseActivity {
    ...
    private void getdata() {
        ...
        LoginController.non_arrival_member2(params, parts, new InterfaceManger.OnRequestListener() {
            @Override
            public void onSuccess(Object success) {
                LinearLayoutManager layoutManager = new LinearLayoutManager(MeetingCheckDetailNoMemberActivity.this);
