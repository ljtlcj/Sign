...
import static com.example.jie.sign.R.id.rv_list;
...
public class MeetingCheckDetailMemberActivity extends BaseActivity {
    ...
    private void getdata() {
        ...
        LoginController.all_member2(params, parts, new InterfaceManger.OnRequestListener() {
            @Override
            public void onSuccess(Object success) {
                LinearLayoutManager layoutManager = new LinearLayoutManager(MeetingCheckDetailMemberActivity.this);
